...
title zDPI - Hizmet Kur (Mod 3 (Agresif Multi-Disorder))
...
echo [*] zDPI Hizmeti kuruluyor (Mod 3 (Agresif Multi-Disorder))...
sc create "zDPI" binPath= ""%CORE_EXE%" %ARGS%" DisplayName= "zDPI Bypass Service" start= auto >nul 2>&1
sc description "zDPI" "zDPI Engine by FRKN (Mod 3 (Agresif Multi-Disorder))" >nul 2>&1
...
echo.
echo =======================================================================
echo Mod 3 (Agresif Multi-Disorder) BASARIYLA KURULDU VE BASLATILDI!
echo =======================================================================
pause
