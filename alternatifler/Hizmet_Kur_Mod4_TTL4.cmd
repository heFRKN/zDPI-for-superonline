...
title zDPI - Hizmet Kur (Mod 4 (TTL 4 Turkcell))
...
echo [*] zDPI Hizmeti kuruluyor (Mod 4 (TTL 4 Turkcell))...
sc create "zDPI" binPath= ""%CORE_EXE%" %ARGS%" DisplayName= "zDPI Bypass Service" start= auto >nul 2>&1
sc description "zDPI" "zDPI Engine by FRKN (Mod 4 (TTL 4 Turkcell))" >nul 2>&1
...
echo.
echo =======================================================================
echo Mod 4 (TTL 4 Turkcell) BASARIYLA KURULDU VE BASLATILDI!
echo =======================================================================
pause
