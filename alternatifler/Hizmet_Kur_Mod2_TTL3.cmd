...
title zDPI - Hizmet Kur (Mod 2 (TTL 3 Superonline))
...
echo [*] zDPI Hizmeti kuruluyor (Mod 2 (TTL 3 Superonline))...
sc create "zDPI" binPath= ""%CORE_EXE%" %ARGS%" DisplayName= "zDPI Bypass Service" start= auto >nul 2>&1
sc description "zDPI" "zDPI Engine by FRKN (Mod 2 (TTL 3 Superonline))" >nul 2>&1
...
echo.
echo =======================================================================
echo Mod 2 (TTL 3 Superonline) BASARIYLA KURULDU VE BASLATILDI!
echo =======================================================================
pause
