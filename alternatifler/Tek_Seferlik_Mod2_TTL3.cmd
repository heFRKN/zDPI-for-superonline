...
title zDPI - Tek Seferlik (Mod 2 (TTL 3 Superonline))
...
echo.
echo -----------------------------------------------------------------------
echo  [+] zDPI Tek Seferlik Mod Aktif (Mod 2 (TTL 3 Superonline))
echo  [+] Bu pencere ACIK KALDIGI SURECE Discord ve tum siteler aciktir.
echo  [+] Kapatmak icin pencereyi kapatin veya Ctrl+C yapin.
echo -----------------------------------------------------------------------
echo.

winws.exe --wf-tcp=80,443 --wf-udp=443,50000-65535 --filter-udp=443,50000-65535 --dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-ttl=3 --new --filter-tcp=80,443 --dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-ttl=3
