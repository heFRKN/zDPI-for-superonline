...
set ARGS=--wf-tcp=80,443 --wf-udp=443,50000,50100 --wf-tcp=80,443 --wf-udp=443,50000-65535 --dpi-desync=fake,split2 --dpi-desync-fooling=md5sig --dpi-desync-repeats=6 --dpi-desync-autottl=2
